...
Following the model of Data C4AC, we organize the course around two sets of questions.
...
- How do the Human Contexts and Ethics concepts of *classification*, *performativity*, *representation*, *agency*, and *narratives* help us see the power embedded in data?
- What does it mean for a statistical tool to be "neutral"? Can the same tool serve both oppression and justice?
- What is the difference between data collected **about** a community, **with** a community, and **by** a community?
- What do we, as responsible data practitioners, owe the people captured in the data we analyze?
...
### Use foundational data science tools

- Navigate Jupyter notebooks; read, write, and run Python code
- Perform exploratory data analysis on a new dataset: `describe`, histograms, box plots, scatter plots
- Compute and interpret correlation coefficients, linear regression slopes, and R-squared values
- Compute and interpret conditional probabilities, rate ratios, and chi-squared tests of independence
- Recreate a historical visualization in Python and critique the rhetorical choices embedded in its design

### Read data critically (the HCE Audit habit)

- Apply a consistent critical reading protocol to any dataset
- Write a structured reflection tying a specific technical finding to a specific historical or policy claim
- Identify sampling bias, proxy variables, and categorization choices in published research
- Compare an original dataset to alternative representations of the same phenomenon

### Produce data responsibly

- Recognize contexts in which a statistical tool's design assumptions violate the reality of the data
- Design an alternative categorization, visualization, or framing that surfaces a perspective the original data obscured
- Reason about the tradeoff between transparency/accountability and individual privacy when working with data about vulnerable populations
...
- **HCE Audit prompt and rubric** — the reusable four-question instrument used at the end of each module
