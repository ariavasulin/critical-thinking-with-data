...
**Optional extension — Final Project.** Students who wish to extend the course may choose a dataset that was not covered and apply the full HCE Audit plus a Du Bois-style counter-visualization. This is framed as an opportunity rather than a requirement; the course's central instrument of assessment is the three HCE Audits. See [Final Project](../final-project/).
